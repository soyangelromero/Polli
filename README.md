...
A privacy-focused interface **exclusively designed for the Pollinations.ai API**. Access the full range of Pollinations models covering **Text, Image, Video, and Audio** generation.

## Key Features

- **Multi-Modal Support**: Integrated support for 45+ models across Text, Image, Video, and Audio categories.
- **Pollinations Integration**: Full compatibility with Pollinations.ai API, including free (pollen) and paid models.
- **Image & Video Generation**: Create visuals using models like Flux, midjourney, and LTX-2 directly from the chat.
- **Audio & TTS**: Text-to-speech with ElevenLabs and specialized audio models.
...
- **Code Generation**: Syntax highlighting and one-click copy for generated code blocks.
